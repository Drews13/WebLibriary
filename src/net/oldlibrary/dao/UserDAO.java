...
import net.weblibrary.controller.AuthFilter;
import net.weblibrary.model.User;

public class UserDAO {
	
	private static final Logger log = Logger.getLogger(UserDAO.class);
	private static String salt="blackb";
	...
	public static String encrypt(String str) {
		if (str!=null) {
			...
			return encoder.encodeToString(new_salt) + encoder.encodeToString(str.getBytes());
		}
		return null;
